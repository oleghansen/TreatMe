...
public class DbHandlerUsedTreatments extends SQLiteOpenHelper 
{
	static String TABLE_USEDTREATMENT="UsedTreatments";
	...
	public DbHandlerUsedTreatments(Context context)
	{
	...
	public	List<Treatment> findAllTreatments(){
		...
		String selectQuery = "SELECT * FROM " + TABLE_USEDTREATMENT;
		SQLiteDatabase db = this.getWritableDatabase();
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_USEDTREATMENT);
		onCreate(db);
	...
	public void addTreatment(Treatment treatment){
		...
		db.insert(TABLE_USEDTREATMENT, null, values);
		db.close();
	}
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.execSQL("DELETE FROM " + TABLE_USEDTREATMENT + " WHERE _ID = " + treatment.getId());
		db.close();
	}
